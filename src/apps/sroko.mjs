    ...
    privacy: {
      bg: {
        ...
        sections: [
          ...
          ['Плащания',
            'Приложението не приема плащания в себе си. Ако платена версия („Pro“) бъде включена, плащането минава изцяло през Google Play — картата и разписката са при Google, ние не ги виждаме и не ги пазим.'],
          ['Твоите права',
      ...
      en: {
        ...
        sections: [
          ...
          ['Payments',
            'The app takes no payments of its own. If a paid version (“Pro”) is enabled, payment goes entirely through Google Play — the card and the receipt are with Google; we never see or store them.'],
          ['Your rights',
